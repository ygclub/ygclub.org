<?php get_header(); ?>
    	...
    	<div id="content">
            ...
            <div id="ygclub_activities">
            	<h3>我们在做什么</h3>
                <ul>
								<script type="text/javascript" src="/bbs/api.php?mod=js&bid=22"></script>	
