...
else
{
    ...
    if(isset($_SESSION['85827X19X504']))
    {
        $_SESSION['85827X19X504'] = trim($_SESSION['85827X19X504']);
        if($_SESSION['85827X19X504'] != '')
        {
            ...
            if(empty($uid))
            {
                $error_message = '您输入的用户名 ' . $bbs_username . ' 尚未在论坛注册，请点击本页面上方的“论坛注册”，完成注册后再将用户名填写在本页面“论坛注册用户名”的输入框中。';
