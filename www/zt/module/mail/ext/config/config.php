...
$config->mail->fromAddress = 'ygclub_noreply@126.com';       // The from address.
$config->mail->fromName    = '阳光项目管理系统'; // The from name.
...
if($config->mail->mta == 'smtp')
{
    ...
    $config->mail->smtp->username = 'ygclub_noreply@126.com';         // The smtp user, may be a full email adress.
    $config->mail->smtp->password = 'viewsonic';         // The smtp user's password.
}
