...
<?php if($task->fromBug == 0):?>
  <div id='main' class='<?php if($task->deleted) echo 'deleted';?>'><?php echo $task->name;?></div>
<?php else:?>
  <div id='main' class='<?php if($task->deleted) echo 'deleted';?>'><?php echo $task->name . '('. $lang->task->fromBug . $lang->colon . $task->fromBug . ')';?></div>
<?php endif;?>
  <div>
  <?php
      ...
      <fieldset>
        ...
        <table class='table-1'> 
          ...
          <tr>
            ...
            <td><?php echo $task->assignedToRealName; ?></td> 
          </tr>  
          <tr>
